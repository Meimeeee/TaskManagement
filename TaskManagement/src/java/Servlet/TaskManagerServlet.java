...
public class TaskManagerServlet extends HttpServlet {
            ...
            if (func != null) {
                switch (func) {
                    case "edit":
                        ...
                        TaskDTO t = dao.getTaskByTaskId(projectId, taskId);
    ...
    private void addTask(HttpServletRequest req, HttpServletResponse resp) throws ClassNotFoundException, IOException, ServletException {
        try {
            ...
            TaskDTO task = new TaskDTO(taskId, taskName, taskDescription, projectId, null, null, createAt, updateAt, dueDate, null);
            TaskDAO dao = TaskDAO.getInstance();
    ...
    private void editTask(HttpServletRequest req, HttpServletResponse resp) throws SQLException, ClassNotFoundException, IOException, ServletException {
        int projectId = Integer.parseInt(req.getParameter("projectId"));
        try {
            int taskId = Integer.parseInt(req.getParameter("taskId"));
            String taskName = req.getParameter("taskName");
