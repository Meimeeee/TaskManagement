                        ...
                        <div class="task-item">
                            ...
                            <div class="task-details">
                                ...
                                <div class="link-submission">
                                    <form method="post" action="">
                                        <input type="hidden" name="id" value="${tasks.taskId}">
                                        <label for="linkSubmission">Link Submission</label>
                                        <input type="url" id="linkSubmission" name="linkSubmission" value="${tasks.linkSubmission}" placeholder="Enter link here">
